...
from repair_alignment.deprecation.execl_operation.config import PT_NUM, LOG_SHEET_NAME, TRACE_NUM, \
    PT_FILE_NAME, LOG_FILE_NAME,  MPT_NUM, MPT_LEVEL, PT_RANGE
...
def create_tree():
    ...
    for i in range(len(PT_NUM)):
        pt_write_to_table(original_e_tab, mutate_e_tabs, PT_NUM[i], PT_RANGE[i][0], PT_RANGE[i][0], MPT_NUM, MPT_LEVEL)
