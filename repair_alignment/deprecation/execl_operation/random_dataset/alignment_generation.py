...
from repair_alignment.repair.lock_pt import align_repair, general_scope_expand, scope_expand
from repair_alignment.deprecation.execl_operation import object_read, utils as excel_utils
from repair_alignment.deprecation.execl_operation.excel_table import ExcelTable
from repair_alignment.evaluation import alignment_on_lock_pt, alignment_on_pt, get_best_cost_on_pt, \
    alignment_on_loop_lock_pt
from repair_alignment.deprecation.execl_operation.config import PT_FILE_NAME, LOG_FILE_NAME, ALIGN_FILE_NAME, ALIGN_SHEET_NAME, \
