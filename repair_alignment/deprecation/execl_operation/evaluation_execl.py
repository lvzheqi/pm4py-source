from repair_alignment.deprecation.execl_operation.random_dataset import dataset_generation
from repair_alignment.deprecation.execl_operation.random_dataset import alignment_generation
from repair_alignment.deprecation.execl_operation.config import REPAIR_RESULTS, ALIGN_FILE_NAME, ALIGN_MTS, MPT_LEVEL, EAP_ALIGNS, OP2_REPAIR_RESULTS
...
if __name__ == "__main__":
    ...
    for i in range(1, len(MPT_LEVEL) + 1):
        ...
        from repair_alignment.deprecation.execl_operation.object_read import read_repair_result_from_file
