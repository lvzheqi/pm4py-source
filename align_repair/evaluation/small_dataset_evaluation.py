...
from align_repair.repair.lock_pt import align_repair, scope_expand
...
# abfbhchehbbhe, ahcchehch, a, ahgbhdbbhbhcbhehehddhchcchaehc, ahacchabchfdccdhchchb, fdch, dch, afb, ahcehehchechc, adebhcbdgdb, ,
