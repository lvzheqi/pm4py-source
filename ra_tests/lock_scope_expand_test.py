...
from repair_alignment.deprecation import to_lock_align
...
class LockScopeExpandTest(unittest.TestCase):
    ...
    def test_scope_expand1(self):
        ...
        s_align = se_rd_lock.apply_with_lock(align, tree1, tree2, self.parameters)
        ...
        s_l_align = se_rd_lock.apply_with_lock(l_align, tree1, tree2, self.parameters_tuple_false)
